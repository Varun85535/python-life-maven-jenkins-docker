...
<body>
  <marquee behavior="scroll" direction="left" style="background-color: #e74c3c; color: white; padding: 10px;">
   LEARN.  PYTHONLIFE-DEVOPS, we don't just teach skills, we ignite careers. Join us and discover the limitless opportunities awaiting you in the world of Python and DevOps - Welcome to PYTHONLIFE-DEVOPS - Your gateway to Python and DevOps expertise!
  </marquee>
